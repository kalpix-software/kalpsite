...
This doc describes the **Player view** in Kalpsite admin: the same shop, wallet, and economy flows as the plak Flutter app, so you can test as the logged-in user.
...
Same behaviour and flows as in **plak** and the design doc:

- **plak:** `plak/docs/SHOP_AND_ECONOMY_UI_UX_DESIGN.md`
