      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            We're building the future of social gaming, one connection at a time
          </p>
        </motion.div>
        ...
        >
          <p className="text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Kalpix Games is more than just a gaming platform—it's a community
            where friendships are forged, skills are honed, and unforgettable
            moments are created. Built with cutting-edge technology and a
            passion for gaming, we're committed to delivering the best social
