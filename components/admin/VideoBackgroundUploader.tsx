    ...
    try {
      ...
      await callAdminRpc(
        ...
        JSON.stringify({
          ...
          // Use what was typed, verbatim. capitalize() lowercases everything after
          // the first character, so "Midnight CITY" silently shipped as
          // "Midnight city" and "NYC Skyline" as "Nyc skyline". The admin typed
          // this field by hand — there is nothing to normalise.
          name: itemName.trim(),
          description: `${itemName.trim()} animated background for Tero (${capitalize(variantSlug)} variant)`,
