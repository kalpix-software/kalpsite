...
const features = [
	{
		...
		description:
			"Connect with friends, join communities, and build your social network.",
	...
	},
	{
		...
		description:
			"Climb leaderboards, earn achievements, and prove your skills.",
	...
	},
	{
		...
		description:
			"Ultra-responsive social experience powered by cutting-edge technology.",
	...
	// },
	{
		icon: Sparkles,
		title: "Customizable",
		description: "Personalize your profile, avatars, and social experience.",
			...
			<div className="max-w-7xl mx-auto">
				...
				>
					<h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
						Social connection with skill-based experiences
					</h2>
					<p className="text-xl text-gray-400 max-w-2xl mx-auto">
						Everything you need for a safe social experience built around short,
						skill-based 2D activities — with chat, posts, avatars, and only
						virtual rewards.
					</p>
				</motion.div>
