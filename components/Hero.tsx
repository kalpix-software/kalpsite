...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-purple-500/30 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
      ...
      >
        ...
        >
          Experience the ultimate social gaming platform where friends meet,
          games come alive, and every moment is a victory.
        </motion.p>
