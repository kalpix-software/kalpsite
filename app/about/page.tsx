...
const company = {
	...
	address:
		"C/O, SUKKHOO PRASAD, O VILL PO, SUNDERPUR, Khojwa Bazar, Varanasi, Varanasi- 221010, Uttar Pradesh, India",
};
			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
				<FadeIn>
					...
					<p className="text-gray-400 text-lg mb-12">
						Kalpix is the social connection platform by Kalpix Software Private
						Limited, built around chat, posts, avatars, and skill-based 2D
						experiences.
					</p>
					...
					<div className="space-y-8">
						<section className="rounded-2xl bg-slate-800/50 border border-slate-700 p-6 md:p-8">
							...
							<p className="text-gray-400 mt-2">
								...
								operate Kalpix—a social platform where people connect, compete
								in friendly skill-based experiences, and enjoy a variety of
								short 2D activities.
							</p>
						</section>
						...
						<section className="rounded-2xl bg-slate-800/50 border border-slate-700 p-6 md:p-8">
							...
							<p className="text-gray-300">
								Incorporated on{" "}
								<strong className="text-white">{company.incorporated}</strong>.
							</p>
							<p className="text-gray-400 mt-2">
								All company documents and registrations are in order and
								available as per applicable law.
							</p>
						</section>
						...
						<section className="rounded-2xl bg-slate-800/50 border border-slate-700 p-6 md:p-8">
							...
							<p className="text-gray-400 mt-2">
								For business, support, or legal inquiries.
							</p>
						</section>
