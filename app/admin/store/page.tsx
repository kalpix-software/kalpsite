                    ...
                    <td className="py-2 px-3">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="min-w-0">
                          ...
                          <br />
                          {item.description ? (
                            <span className="text-xs text-slate-400 line-clamp-1" title={item.description}>
                              {item.description}
                            </span>
                          ) : (
...
function EditRow({
  ...
  return (
    <div className="flex flex-wrap gap-3 items-center">
      <span className="text-xs text-slate-400 w-full">{item.itemId}</span>

      <div className="w-full grid md:grid-cols-2 gap-3">
        <div>
          <label className="block text-xs text-slate-400 mb-1">Name (shown to players)</label>
          <input
            value={item.name}
        ...
        <div>
          <label className="block text-xs text-slate-400 mb-1">
            ...
            <span
              ...
              title="The backend treats an empty value as 'keep the existing one', so a description can be rewritten but not blanked. Use a single character if you need it effectively empty."
            >
          ...
          <input
            ...
            placeholder="Shown under the item in the shop"
            className="w-full px-2 py-1 rounded bg-slate-900 border border-slate-600 text-slate-100 text-sm"
          />
        </div>
      </div>
